...
class AbonnementScreen(MDScreen):
    ...
    def ajouter_abonnement(self):   
        ...
        try:
            ...
            sql = """
                INSERT INTO Abonnement (id_user, id_paiement,reference, dateDebut, dateFin, statut)
                VALUES ( ?, ?, ?, ?, ?, ? )
            """
            valeurs = (id_user, id_paiement, self.reference , date_debut, date_fin, statut)
